    ...
    <main className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 lg:px-16 px-7">
      {apis.map((api) => {
        ...
        return (
          <Card
            key={api.id}
            className=" w-full max-w-sm lg:px-8 px-4  border-[#075affc4] border"
          >
            
            <CardHeader className="flex flex-col lg:gap-4 gap-2 lg:mt-4 mt-2">
                <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#1b497a] text-[#057BFF]">
