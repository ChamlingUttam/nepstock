...
const TailSection = () => {
  return (
    <div className="flex w-full justify-center px-4 pb-10 sm:px-6 md:px-10 lg:px-16 xl:px-20">
      <section className="flex min-h-[430px] w-full max-w-[1500px] flex-col items-center justify-center rounded-2xl bg-[#E6F2FF] px-5 py-10 text-center sm:min-h-[439px] sm:px-8 md:px-12 lg:px-16">

        <p className="text-sm font-semibold leading-5 text-[#007BFF] sm:text-base">
          NEPAL&apos;S #1 INVENTORY MANAGEMENT PLATFORM
        </p>

        <h1 className="mt-5 text-4xl font-bold leading-tight text-black sm:text-4xl md:text-5xl lg:text-6xl">
          Ready to Transform
        ...
        <p className="mt-6 max-w-3xl text-sm font-light leading-6 text-gray-800 sm:text-base">
